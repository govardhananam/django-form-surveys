    ...
    def __init__(self, survey, user, *args, **kwargs):
        ...
        for question in self.questions:
            ...
            if question.type_field == TYPE_FIELD.multi_select:
                ...
                self.fields[field_name] = forms.FileField(label=question.label)
            else:
                self.fields[field_name] = forms.CharField(
                    label=question.label,
    ...
    def save(self):
        ...
        for question in self.questions:
            ...
            Answer.objects.create(
                question=question, value=value, file=file, user_answer=user_answer
            )
    ...
    def save(self):
        ...
        for question in self.questions:
            ...
            if question.type_field == TYPE_FIELD.multi_select:
                ...
                value = cleaned_data[field_name]
            if question.type_field == TYPE_FIELD.file:
                value = cleaned_data[field_name].name
                file = cleaned_data[field_name]
